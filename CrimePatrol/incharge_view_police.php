...
<?php
    ...
    $result1=$conn->query("SELECT location FROM police_station where i_id='$i_id'");
     ...
     if(isset($_POST['s2']))
    {
        if($_SERVER["REQUEST_METHOD"]=="POST")
        {
            ...
            $q1=$conn->query("delete from police where p_id='$pid'");
            $q3=$conn->query("update complaint set pol_status='null',inc_status='Unassigned',p_id='Null' where p_id='$pid'");
        }
    }
    
    
    $result=$conn->query("select p_id,p_name,spec,location from police where location='$location'");  
...
<div style="position: fixed;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>Crime Patrol</b></h4>
</div>
