...
<?php
    ...
    if(isset($_POST['status'])){
        ...
        {
            $upd=$_POST['update'];
            $qu1=$conn->query("insert into update_case(c_id,case_update) values('$cid','$upd')");
        }
    }
    ...
    if(isset($_POST['close'])){
        if($_SERVER["REQUEST_METHOD"]=="POST")
        {
            ...
            $qu2=$conn->query("insert into update_case(c_id,case_update) values('$cid','$up')");
            $q2=$conn->query("update complaint set pol_status='ChargeSheet Filed' where c_id='$cid'");
